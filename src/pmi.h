...
#ifndef PMI_ATTRIBUTE_VISIBILITY
#if defined(OPAL_C_HAVE_VISIBILITY) && (OPAL_C_HAVE_VISIBILITY == 1)
#define PMI_ATTRIBUTE_VISIBILITY __attribute__((visibility("default")))
#else
#define PMI_ATTRIBUTE_VISIBILITY
#endif
#endif

#ifndef PMI_FUNCTION_ATTRIBUTES
#define PMI_FUNCTION_ATTRIBUTES PMI_ATTRIBUTE_VISIBILITY
#endif
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Init(int *spawned);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Initialized(int *initialized);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Finalize(void);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Get_size(int *size);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Get_rank(int *rank);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Get_universe_size(int *size);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Get_appnum(int *appnum);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Publish_name(const char service_name[], const char port[]);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Unpublish_name(const char service_name[]);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Lookup_name(const char service_name[], char port[]);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Barrier(void);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Abort(int exit_code, const char error_msg[]);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Get_my_name(char kvsname[], int length);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Get_name_length_max(int *length);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Get_key_length_max(int *length);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Get_value_length_max(int *length);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Put(const char kvsname[], const char key[], const char value[]);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Commit(const char kvsname[]);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Get(const char kvsname[], const char key[], char value[],
                                        int length);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Spawn_multiple(int count, const char *cmds[], const char **argvs[],
