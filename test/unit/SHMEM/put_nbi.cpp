...
GEN_MEM_FNS(putmem_nbi, NOP, nop)
...
int main(int argc, char **argv)
{
    ...
    GEN_TABLES(put_nbi, NOP, nop)
    GEN_MEM_TABLES(putmem_nbi, NOP, nop)
    GEN_SIZE_TABLES(put, _nbi, NOP, nop)
